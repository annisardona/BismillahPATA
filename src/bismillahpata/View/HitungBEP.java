 ...
 * @author Suryadi
 */
public class HitungBEP extends javax.swing.JFrame {
    private Object[] columnsNames = {"ID Pengeluaran", "Nama Pengeluaran", "Jumlah", "Harga Satuan", "Satuan"};
...
//        DataSession.setIdProduk(p.getIdProduk());
    ...
    private void simpenTabel(){
        List<DataTransaksi> listDTSBEP = pc.getListDetailDTSBEP();
        for(DataTransaksi dts : listDTSBEP){
            Object[] his = {
                id = dts.getIdData(),
    ...
    private void initTable(){
        ...
        tableView3.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
    }
    
    public String generate(){
        String prefix = "DTPB";
//        int rowCount = tableView3.getRowCount()+1;
//        String generatedId = prefix+""+rowCount;
    ...
    private double hitungTotal(){
        ...
        int rowCount = tableView3.getRowCount();
        
        System.out.println("Jumlah baris pada tabel : "+rowCount);
        
        for(int i = 0; i<rowCount; i++){
            subtotal = Double.parseDouble((String) tableView3.getValueAt(i, 2)) * Double.parseDouble((String) tableView3.getValueAt(i, 3));
            total += subtotal;
        }
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Hitung Harga Keseimbangan");
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(SubmitTabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        tableView3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableView3MouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tableView3);
        ...
        jLabel11.setText("Pengeluaran Penyusutan Barang");
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnNext, javax.swing.GroupLayout.PREFERRED_SIZE, 590, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void SubmitTabelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitTabelActionPerformed
        ...
        tableView3.getColumnModel().getColumn(3).setCellRenderer((rightRender));
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        int baris = tableView3.getSelectedRow();
        if(baris >= 0){
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        int baris = tableView3.getSelectedRow();
        if(baris != -1){
            String data = tableView3.getValueAt(baris, 0).toString();
    ...
    private void tableView3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableView3MouseClicked
        int i = tableView3.getSelectedRow();
        TableModel model = tableView3.getModel();
    ...
    }//GEN-LAST:event_tableView3MouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HitungBEP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
